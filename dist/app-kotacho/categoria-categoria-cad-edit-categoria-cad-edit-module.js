(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["categoria-categoria-cad-edit-categoria-cad-edit-module"],{
...
class CategoriaCadEditComponent {
    ...
    deletar() {
        ...
        dialogoReferencia.afterClosed().subscribe((valorResposta) => {
            if (valorResposta) {
                this.categoriaService.deletar(this.categoria.id).subscribe((response) => {
...
//# sourceMappingURL=categoria-categoria-cad-edit-categoria-cad-edit-module.js.map