...
function ProdutoCadEditComponent_mat_option_24_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("value", categoria_r3);
...
ProdutoCadEditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ProdutoCadEditComponent, selectors: [["app-produto-cad-edit"]], viewQuery: function ProdutoCadEditComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 50, vars: 5, consts: [[1, "title-group"], [1, "mat-h1"], ["fxFlex", "1 0"], [1, "inner-wrapper"], [3, "formGroup", "ngSubmit"], [1, "controlers-wrapper"], [1, "example-full-width"], ["matInput", "", "placeholder", "Nome", "formControlName", "nome", "required", ""], ["name", ""], ["matInput", "", "placeholder", "Detalhes do Produto", "formControlName", "detalhe"], ["formControlName", "categoria", "required", ""], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "medida", "required", ""], ["matInput", "", "placeholder", "000,00", "mask", "000,00|00,00", "formControlName", "precoCusto", "required", "", "autocomplete", "off"], ["matInput", "", "placeholder", "Pre\u00E7o de Venda", "formControlName", "precoVenda", "required", "", "autocomplete", "off"], [1, "example-section"], ["id", "ativo", "color", "primary", "formControlName", "ativo", 1, "ativo"], ["mat-raised-button", "", "color", "primary", 3, "disabled"], ["type", "button", "mat-raised-button", "", "routerLink", "/produtos"], [3, "value"]], template: function ProdutoCadEditComponent_Template(rf, ctx) { if (rf & 1) {
...
//# sourceMappingURL=3.e15f69ab41667e2cb46a.js.map