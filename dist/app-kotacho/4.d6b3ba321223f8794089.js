...
class ProdutoService {
    ...
    pesquisarPorCod(cod) {
        return this.httpClient.get(`${this.baseURL}/${this.endpoint}/${cod}/cod`);
    }
    atualizar(produto) {
...
/* harmony import */ var _util_Pagination__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../_util/Pagination */ "13C5");
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/environments/environment */ "AytR");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common/http */ "tk/3");
/* harmony import */ var _produto_produto_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../produto/produto.service */ "UICN");
...
class PedidoService {
    constructor(httpClient, produtoService) {
        this.httpClient = httpClient;
        this.produtoService = produtoService;
        this.baseURL = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].api.apiUrl;
    ...
    listar(queryBuilder) {
        return this.httpClient
            .get(`${this.baseURL}/${this.endpoint}?${queryBuilder.buildQueryString()}`, { observe: 'response' })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => _util_Pagination__WEBPACK_IMPORTED_MODULE_4__["Page"].fromResponse(response)));
    }
    cadastrar(pedido) {
    ...
    alterarSituacao(pedidos) {
        return this.httpClient.post(`${this.baseURL}/${this.endpoint}`, pedidos);
    }
    deletar(_id) {
        return this.httpClient.delete(`${this.baseURL}/${this.endpoint}/${_id}`);
    }
    consultarPreco(idProduto) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const result = yield this.produtoService.pesquisarPorId(idProduto).toPromise();
            return result;
        });
    }
    atualizarPrecos(updatePrecoFinal, pedido) {
        pedido.itens.forEach((item) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const prod = yield this.consultarPreco(item.produto.id);
            if (updatePrecoFinal) {
...
PedidoService.ɵfac = function PedidoService_Factory(t) { return new (t || PedidoService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_produto_produto_service__WEBPACK_IMPORTED_MODULE_7__["ProdutoService"])); };
PedidoService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({ token: PedidoService, factory: PedidoService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](PedidoService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClient"] }, { type: _produto_produto_service__WEBPACK_IMPORTED_MODULE_7__["ProdutoService"] }]; }, null); })();
...
//# sourceMappingURL=4.d6b3ba321223f8794089.js.map