...
ClienteListarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ClienteListarComponent, selectors: [["app-cliente-listar"]], decls: 26, vars: 3, consts: [[1, "example-button-row", "right"], ["mat-fab", "", "color", "success", "routerLink", "/clientes/cadastrar"], [1, "title-group"], [1, "mat-h4"], [1, "mat-elevation-z4"], ["mat-table", "", "matSort", "", 3, "dataSource", "matSortChange"], ["matColumnDef", "cli_id"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "nome"], ["matColumnDef", "cnpj"], ["matColumnDef", "ativo"], ["matColumnDef", "action"], [4, "matCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-icon-button", "", 3, "click"], ["mat-icon-button", "", "color", "warn", 3, "click"], ["mat-header-row", ""], ["mat-row", ""]], template: function ClienteListarComponent_Template(rf, ctx) { if (rf & 1) {
...
//# sourceMappingURL=8.3a6bd9272202deff3ca3.js.map