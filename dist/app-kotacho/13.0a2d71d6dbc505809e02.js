...
class RelatorioComponent {
    ...
    gerarRelatorioPrecos() {
        this.relatorioService.relatorioPrecos().subscribe((result) => {
            const blob = new Blob([result], { type: "application/pdf" });
            Object(file_saver__WEBPACK_IMPORTED_MODULE_1__["saveAs"])(blob, "rel_precos_produto.pdf");
        });
    }
}
...
RelatorioComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RelatorioComponent, selectors: [["app-relatorio"]], decls: 9, vars: 0, consts: [[1, "title-group"], [1, "mat-h1"], ["fxFlex", "1 0"], [1, "example-button-row", "right"], ["mat-button", "", "color", "primary", 3, "click"]], template: function RelatorioComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RelatorioComponent_Template_button_click_7_listener() { return ctx.gerarRelatorioPrecos(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](8, "Produtos");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
//# sourceMappingURL=13.0a2d71d6dbc505809e02.js.map