(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pedido-pedido-cad-edit-pedido-cad-edit-module"],{
...
/* harmony import */ var _add_produto_form_add_produto_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../add-produto-form/add-produto.component */ "uBfb");
...
class PedidoCadEditComponent {
    ...
    buildForm() {
        this.formCadastro = this.fb.group({
            ...
            status: [this.statusList[0], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            desconto: [],
            total: [""],
            obs: [""],
            item: this.fb.group({
...
PedidoCadEditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PedidoCadEditComponent, selectors: [["app-pedido-cad-edit"]], viewQuery: function PedidoCadEditComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵviewQuery"](_carrinho_compras_carrinho_component__WEBPACK_IMPORTED_MODULE_3__["CarrinhoComponent"], true);
    } if (rf & 2) {
        var _t;
...
//# sourceMappingURL=pedido-pedido-cad-edit-pedido-cad-edit-module.js.map